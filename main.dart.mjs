...
_1618: (x0,x1) => x0.removeItem(x1),
_1619: (x0,x1,x2) => x0.setItem(x1,x2),
_1620: (x0,x1) => x0.matchMedia(x1),
_1631: x0 => new Array(x0),
_1665: (decoder, codeUnits) => decoder.decode(codeUnits),
_1666: () => new TextDecoder("utf-8", {fatal: true}),
_1667: () => new TextDecoder("utf-8", {fatal: false}),
_1668: v => stringToDartString(v.toString()),
_1669: (d, digits) => stringToDartString(d.toFixed(digits)),
_1673: o => new WeakRef(o),
_1674: r => r.deref(),
_1679: Date.now,
...
_1692: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1693: s => printToConsole(stringFromDartString(s)),
_1702: (o, t) => o instanceof t,
...
_1708: (handle) => clearTimeout(handle),
_1709: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1710: (handle) => clearInterval(handle),
_1711: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1712: () => Date.now(),
_1718: () => new XMLHttpRequest(),
_1719: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1720: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1721: (x0,x1) => x0.send(x1),
_1722: x0 => x0.abort(),
_1723: x0 => x0.getAllResponseHeaders(),
_1730: f => finalizeWrapper(f,x0 => dartInstance.exports._1730(f,x0)),
_1731: f => finalizeWrapper(f,x0 => dartInstance.exports._1731(f,x0)),
_1749: (x0,x1) => x0.key(x1),
_1750: (a, i) => a.push(i),
_1754: a => a.pop(),
...
_1773: s => s.trimLeft(),
_1774: s => s.trimRight(),
_1776: (s, p, i) => s.indexOf(p, i),
_1777: (s, p, i) => s.lastIndexOf(p, i),
...
_1825: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1826: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1828: (s, m) => {
          try {
...
_1832: (x0,x1) => x0.exec(x1),
_1833: x0 => x0.pop(),
_1837: (x0,x1,x2) => x0[x1] = x2,
_1839: o => o === undefined,
_1840: o => typeof o === 'boolean',
_1841: o => typeof o === 'number',
_1843: o => typeof o === 'string',
_1846: o => o instanceof Int8Array,
_1847: o => o instanceof Uint8Array,
...
_1852: o => o instanceof Uint32Array,
_1853: o => o instanceof Float32Array,
_1854: o => o instanceof Float64Array,
_1855: o => o instanceof ArrayBuffer,
_1856: o => o instanceof DataView,
_1857: o => o instanceof Array,
_1858: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1860: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1861: o => o instanceof RegExp,
_1862: (l, r) => l === r,
_1863: o => o,
_1864: o => o,
_1865: o => o,
...
_1867: o => o.length,
_1870: (o, i) => o[i],
_1871: f => f.dartFunction,
_1872: l => arrayFromDartList(Int8Array, l),
_1873: l => arrayFromDartList(Uint8Array, l),
_1874: l => arrayFromDartList(Uint8ClampedArray, l),
_1875: l => arrayFromDartList(Int16Array, l),
_1876: l => arrayFromDartList(Uint16Array, l),
_1877: l => arrayFromDartList(Int32Array, l),
_1878: l => arrayFromDartList(Uint32Array, l),
_1879: l => arrayFromDartList(Float32Array, l),
_1880: l => arrayFromDartList(Float64Array, l),
_1881: (data, length) => {
...
_1882: l => arrayFromDartList(Array, l),
_1883: stringFromDartString,
_1884: stringToDartString,
_1885: () => ({}),
_1886: () => [],
_1887: l => new Array(l),
_1888: () => globalThis,
_1889: (constructor, args) => {
...
_1891: (o, p) => o[p],
_1892: (o, p, v) => o[p] = v,
_1893: (o, m, a) => o[m].apply(o, a),
_1895: o => String(o),
_1896: (p, s, f) => p.then(s, f),
_1897: s => {
...
_1902: x0 => x0.length,
_1904: (x0,x1) => x0[x1],
_1906: (x0,x1) => x0.exec(x1),
_1908: x0 => x0.flags,
_1909: x0 => x0.multiline,
_1910: x0 => x0.ignoreCase,
_1911: x0 => x0.unicode,
_1912: x0 => x0.dotAll,
_1913: (x0,x1) => x0.lastIndex = x1,
_1921: () => globalThis.window,
_1942: x0 => x0.matches,
_1946: x0 => x0.platform,
_1951: x0 => x0.navigator,
_1995: (x0,x1) => x0.withCredentials = x1,
_1998: x0 => x0.responseURL,
_1999: x0 => x0.status,
_2000: x0 => x0.statusText,
_2001: (x0,x1) => x0.responseType = x1,
_2003: x0 => x0.response,
_3760: () => globalThis.window,
_3820: x0 => x0.location,
_3840: x0 => x0.navigator,
_4098: x0 => x0.localStorage,
_4107: x0 => x0.href,
_4321: x0 => x0.userAgent,
_4539: x0 => x0.length
    };
